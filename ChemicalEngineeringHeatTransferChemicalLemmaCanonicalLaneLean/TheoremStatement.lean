import HautevilleHouse.ChemicalEngineeringHeatTransferChemicalLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  certificateLane := "heat_transfer_constrained",
...
def ManifoldConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "heat_transfer_constrained" ∧
